...
public class PageFactory {
    ...
    private com.mars.blackcat.view.ReadView.OnReadStateChangeListener listener;
    ...
    public void setOnReadStateChangeListener(com.mars.blackcat.view.ReadView.OnReadStateChangeListener listener) {
